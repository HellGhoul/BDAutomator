...
// Handle both IPC messages and stdin input
...
// Only handle stdin input if this script is being run directly (not imported as module)
if (require.main === module) {
  // Handle stdin input for console mode
  if (process.stdin.isTTY) {
    // Not running in console mode - this means it's being called directly
    // Don't do anything, let the calling script handle it
  } else {
    let inputData = '';
...
// Export the runAutomation function for use in console apps
